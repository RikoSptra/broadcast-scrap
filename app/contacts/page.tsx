...
import { ArrowLeft, Search, Filter, Download, Users, Circle, Plus } from 'lucide-react'
...
export default function AllContacts() {
  ...
  const filteredContacts = contacts.filter(contact => {
    ...
    const matchesSource = sourceFilter === "all" || contact.source.toLowerCase().includes(sourceFilter.toLowerCase())
    const matchesBroadcast = broadcastFilter === "all" || contact.broadcastSource.toLowerCase().includes(broadcastFilter.toLowerCase())
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-green-100">Semua contact terpusat dari berbagai broadcast</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Semua contact terdaftar</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Contact yang sedang online</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Contact yang sedang offline</p>
            </CardContent>
          </Card>
        </div>
                ...
                <TableBody>
                  {filteredContacts.map((contact) => (
                    <TableRow key={contact.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center">
                          ...
                          <Badge 
                            ...
                            className={contact.status === 'online' ? 'bg-green-500' : ''}
                          >
                            {contact.status === 'online' ? 'Online' : 'Offline'}
                          </Badge>
                        </div>
                      </TableCell>
                      <TableCell className="text-sm text-gray-600">{contact.lastSeen}</TableCell>
                      ...
                      <TableCell>
                        <Badge variant="outline">{contact.broadcastCount}</Badge>
                      </TableCell>
                      <TableCell className="text-sm text-gray-600">{contact.lastBroadcast}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
